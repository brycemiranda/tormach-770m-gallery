...
const EQUIPMENT = {
  ...
  "8l": {
    chucks: [
      {
        id: "8l-3jaw",
        name: "3-Jaw Self-Centering Chuck (4\")",
        code: "CH-01",
        icon: "vise",
        photo: "chucks/8l-3jaw-4inch.webp",
        ...
        notes: "Self-centering scroll chuck — fast to load, but confirm true-running on precision work since scroll chucks wear unevenly over time.",
      },
      {
        id: "8l-4jaw",
        name: "4-Jaw Independent Chuck (4\")",
        code: "CH-02",
        icon: "vise",
        photo: "chucks/8l-4jaw-4inch.webp",
        ...
        notes: "Each jaw adjusts independently; part must be dial-indicated true before running.",
      },
      {
        id: "8l-5c-collet-set",
        ...
        code: "CH-03",
        icon: "vise",
        photo: "chucks/8l-5c-collet-set.jpg",
